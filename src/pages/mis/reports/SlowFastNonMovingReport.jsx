...
const SlowFastNonMovingReport = () => {
  ...
  const handlePrintPDF = () => {
    ...
    doc.setFont("helvetica", "bold");
    doc.setFontSize(11);
    doc.text(`${reportData.reportType.toUpperCase()} REPORT (${reportData.valueType.toUpperCase()})`, pageWidth - 14, 14, { align: 'right' });
    ...
    doc.text(`Store Scope: ${storeLabel} | Category: ${selectedCategory} | Brand: ${selectedBrand}`, 14, 35);
    ...
    const head = [[
      ...
      'Stock', 'Cost (TP)', 'MRP', 'Sold Qty', 'Total Sales (Tk)', 'Status'
    ]];
