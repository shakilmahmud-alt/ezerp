...
const ItemwiseProfitReport = () => {
  ...
  const handlePrintPDF = () => {
    ...
    doc.setFont("helvetica", "bold");
    doc.setFontSize(11);
    doc.text("ITEMWISE PROFIT REPORT", pageWidth - 14, 14, { align: 'right' });
    ...
    doc.text(`Category: ${selectedCategory} | Sub Category: ${selectedSubCategory} | Brand: ${selectedBrand}`, 14, 35);
    ...
    const head = [[
      ...
      'Profit (Tk)', 'Profit % (TP)', 'Profit % (MRP)'
    ]];
