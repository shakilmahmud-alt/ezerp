...
const UserWiseInvoiceSummaryReport = () => {
  ...
  const handlePrintPDF = () => {
    ...
    const userLabel = selectedUser === 'ALL' || !selectedUser ? 'ALL' : (employees.find(e => e.id === selectedUser)?.name || selectedUser);
    doc.text(`Date Range: ${fromDate} to ${toDate}`, 14, 30);
    doc.text(`Store Scope: ${storeLabel} | User: ${userLabel} | Terminal: ${selectedTerminal}`, 14, 35);
